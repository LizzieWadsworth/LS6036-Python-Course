...
However, when we create a new variable inside a function it is a **local** variable. This is a _temporary_ variable, that only exists while we're running the function and is then deleted. 
